 ...
 * @author damine
 */
public class GalleryFXDemo  {
    
    
    public  final double WIDTH = 450, HEIGHT = 300;
    ...
    public static class DisplayShelf extends Region {
        ...
        public void shiftToCenter(PerspectiveImage item) {
            for (int i = 0; i < left.getChildren().size(); i++) {
    ...
    public double getSampleWidth() { return 450; }
