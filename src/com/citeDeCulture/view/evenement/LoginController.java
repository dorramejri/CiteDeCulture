...
import com.citeDeCulture.entities.*;
import com.citeDeCulture.sercicesImpl.UserService;
...
if ( user.getText().equals("said@gmail.com"))
{
        ...
        Template.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/com/citeDeCulture/view/evenement/MyMenuFXML.fxml"))));             
//admin
