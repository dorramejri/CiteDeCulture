  ...
  nbrnotif =s.nbr();
    ...
    private void LoadUI(String ui)
    {
        ...
        try {
            ...
            root= FXMLLoader.load(getClass().getResource("/com/citeDeCulture/view/evenement/"+ui+".fxml"));
    ...
    private void notif(MouseEvent event) throws IOException {
        ...
        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/com/citeDeCulture/view/evenement/NotifFXML.fxml")));
